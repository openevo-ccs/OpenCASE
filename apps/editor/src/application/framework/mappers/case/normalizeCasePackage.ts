...
export function normalizeCasePackageResponse(res: unknown): CasePackageSnapshot | null {
  ...
  return {
    ...
    document: {
      ...
      publisher: asString(doc.publisher),
      // v1p1 additions
      ...
      officialSourceURL: asString(doc.officialSourceURL),
      subject: asStringArray(doc.subject),
      subjectURI: extractLinkURIArray(doc.subjectURI),
      statusStartDate: asString(doc.statusStartDate),
