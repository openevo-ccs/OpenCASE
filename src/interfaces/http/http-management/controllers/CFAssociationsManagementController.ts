...
export class CFAssociationsManagementController {
  constructor (
    private readonly updateCFAssociation: UpdateCFAssociation,
    private readonly deleteCFAssociation: DeleteCFAssociation
  ) {}
  ...
  update = async (req: Request, res: Response) => {
    try {
      ...
      await this.updateCFAssociation.execute({
        tenantId,
        caseVersion,
        sourcedId,
        payload: req.body
  ...
  delete = async (req: Request, res: Response) => {
    try {
      ...
      await this.deleteCFAssociation.execute({
        tenantId,
        caseVersion,
        sourcedId
      })
